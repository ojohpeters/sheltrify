...
$apiKey = getenv('UPLOAD_API_KEY') ?: 'your-secret-api-key-change-this';
...
// Validate file size (15MB max for videos, 5MB for images)
$maxSize = $fileType === 'videos' ? 15 * 1024 * 1024 : 5 * 1024 * 1024;
if ($file['size'] > $maxSize) {
    http_response_code(400);
    echo json_encode([
        'success' => false,
        'message' => 'File too large. Max size: ' . ($fileType === 'videos' ? '15MB' : '5MB')
    ]);
    exit();
}
